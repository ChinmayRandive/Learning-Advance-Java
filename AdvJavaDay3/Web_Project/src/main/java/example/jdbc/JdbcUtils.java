...
public class JdbcUtils {
	...
	public static Connection getConnection() throws Exception {
		...
		String connectionUrl ="jdbc:mysql://localhost:3306/cdac?useSSL=false&allowPublicKeyRetrieval=true";  //URL= Uniform Resource Locator //?useSSL=false  => to remove error or exception
